...
import com.oracle.truffle.sl.parser.SavoLanguageLexer;
 ...
 * The syntax is described as an attributed grammar. The {@link SavoLanguageParser} and
 * {@link SavoLanguageLexer} are automatically generated by ANTLR 4. The grammar contains semantic
...
public final class SavoLanguage extends TruffleLanguage<SLContext> {
    ...
    protected CallTarget parse(ParsingRequest request) throws Exception {
        ...
        if (request.getArgumentNames().isEmpty()) {
            functions = SavoLanguageParser.parseSL(this, source);
        } else {
            ...
            functions = SavoLanguageParser.parseSL(this, decoratedSource);
        }
