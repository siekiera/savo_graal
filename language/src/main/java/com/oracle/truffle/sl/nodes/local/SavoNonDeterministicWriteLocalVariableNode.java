...
/**
 * Non-deterministic local variable assigment a.k.a. "voepha tuota ollakkii"
 */
@NodeChild("valueNode")
@NodeField(name = "slot", type = FrameSlot.class)
public abstract class SavoNonDeterministicWriteLocalVariableNode extends SLExpressionNode {
	...
	protected long writeLong(VirtualFrame frame, long value) {
		...
		value = shouldReturnWhatAsked() ? value : random.nextInt((int) value);
	...
	protected boolean writeBoolean(VirtualFrame frame, boolean value) {
		...
		value = shouldReturnWhatAsked() == value;
	...
	protected Object write(VirtualFrame frame, Object value) {
		...
		value = shouldReturnWhatAsked() ? value : SLNull.SINGLETON;
